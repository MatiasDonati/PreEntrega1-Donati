...
const ItemCount = ({ stock }) => {
    ...
    const { sumarCantidad, restarCantidadContador, reset, contador } = useCart()

    return (
        <>
            <div className="text-center">
                <div className="flex justify-center space-x-4">
                    <button onClick={restarCantidadContador} className="bg-violet-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full">-</button>
                    <p>{contador}</p>
